...
def run_workflow(DATA_PATH):
    ...
    props["pegasus.catalog.workflow.amqp.url"] = "amqp://panorama:panorama@hostname:5674/panorama/monitoring"
    props.write()
    ...
    preprocess_images = Transformation("preprocess_images", site="condorpool",
                                    pfn = "file:///nfs/shared/panorama/bin/GalaxyClassification/preprocess_resize.py", 
    ...
    augment_images = Transformation("augment_images", site="condorpool",
                                    pfn = "file:///nfs/shared/panorama/bin/GalaxyClassification/preprocess_augment.py", 
                                    is_stageable= False, container=galaxy_container)

    # HPO: main script
    vgg16_hpo = Transformation("vgg16_hpo",
                   site="condorpool",
                   pfn = "file:///nfs/shared/panorama/bin/GalaxyClassification/vgg16_hpo.py", 
                   is_stageable= False,
    ...
    train_model = Transformation("train_model",
                      site="condorpool",
                      pfn = "file:///nfs/shared/panorama/bin/GalaxyClassification/train_model_vgg16.py", 
                      is_stageable= False, 
                      container=galaxy_container
                  )\
                  .add_pegasus_profile(cores=24, gpus=1, memory=131072, runtime=43200, grid_start_arguments="-G -m 10")\
    ...
    eval_model = Transformation("eval_model",
                     site="condorpool",
                     pfn = "file:///nfs/shared/panorama/bin/GalaxyClassification/eval_model_vgg16.py", 
                     is_stageable= False,
                     container=galaxy_container
                 )\
                .add_pegasus_profile(cores=24, gpus=1, memory=131072, runtime=43200, grid_start_arguments="-G -m 10")\
